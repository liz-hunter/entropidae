...
cd $MYPATH/entropy/
FILE=$(head -n $SLURM_ARRAY_TASK_ID sample_lists/insilico_list.txt | tail -n 1)
...
$MYPATH/metagen/insilicoseq/rl_mixtures/mixtures/${FILE}-1_R1.fastq.gz \
$MYPATH/metagen/insilicoseq/rl_mixtures/mixtures/${FILE}-1_R2.fastq.gz
